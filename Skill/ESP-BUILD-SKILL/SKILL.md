...
```bash
# AI 用 bash 调用（推荐，避免 Start-Job 安全限制）：
...
```powershell
& "B:\CaPilot\Skill\ESP-BUILD-SKILL\scripts\build-flash-monitor.ps1" -ProjectDir "B:\CaPilot" -AppName "keyboard_demo" -ComPort "COM8" -MonitorSec 15
```
